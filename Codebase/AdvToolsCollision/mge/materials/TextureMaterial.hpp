...
class TextureMaterial : public AbstractMaterial
{
    public:
        ...
        void addSplatTexture(Texture* pTexture, int nr);
    ...
    private:
        ...
        static GLint _uSplatTexture1;
        static GLint _uSplatTexture2;
        static GLint _uSplatTexture3;
        static GLint _uSplatTexture4;
        ...
        Texture* _splatTexture1;
        Texture* _splatTexture2;
        Texture* _splatTexture3;
        Texture* _splatTexture4;
